...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validate the user
    $sql = "SELECT * FROM userstb WHERE user_name = '$username'";
...
<head>
    ...
    <title>Makala Inc - Login Page</title>
...
<body>
    ...
    <a class="navbar-brand" href="index.php">Makala Inc</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                ...
                // Display "Admin Login" if the user is not logged in
    ...
    <div class="login-container">
        <div class="login-card">
            <h2 class="mb-4">Super User Login</h2>
